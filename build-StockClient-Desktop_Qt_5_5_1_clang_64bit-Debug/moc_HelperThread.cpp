...
#include "../StockClient/HelperThread.h"
...
QT_MOC_LITERAL(1, 13, 10), // "sig_sliter"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 9), // "StockTick"
QT_MOC_LITERAL(4, 35, 1) // "t"

    },
    "HelperThread\0sig_sliter\0\0StockTick\0t"
};
...
void HelperThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_sliter((*reinterpret_cast< StockTick(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (HelperThread::*_t)(StockTick );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HelperThread::sig_sliter)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void HelperThread::sig_sliter(StockTick _t1)
{
